  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 bg-background">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard icon={<PersonIcon className="h-4 w-4" />} title="Total Employees" value="867" trend={5.2} />
      
        <StatCard icon={<Timer className="h-4 w-4" />} title="On Time Today" value="85" trend={3.7} />
        <StatCard icon={<MessageSquareWarningIcon className="h-4 w-4" />} title="Late Today" value="68" trend={-2.5} />
        <StatCard icon={<DollarSign className="h-4 w-4" />} title="Monthly Payroll" value="78%" trend={0} />
      </div>
      ...
      <div className="grid w-full gap-4 grid-cols-1">
        <Card className="col-span-2 md:col-span-3 w-full">
          <CardHeader>
            ...
            <CardDescription>Percentage of Attendance and Late troughout the year</CardDescription>
          </CardHeader>
          <CardContent> 
            <ChartContainer config={medicineChartConfig} className="h-[250px] w-full">
